...
<a name='L438'></a><a href='#L438'>438</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        if (!metadata.$schema) {
            metadata.$schema = 'https://hyperledger.github.io/fabric-chaincode-node/main/api/contract-schema.json';
        }
&nbsp;
