...
function createOrg1() {
  ...
  set -x
  fabric-ca-client enroll -u https://ADMIN-adminOrg1:adminpw@localhost:7054 --caname ca-org1 --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client register --caname ca-org1 --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/org1/ca-cert.pem" --id.attrs 'userId=user1:ecert,userRole=DOCTOR:ecert'
  { set +x; } 2>/dev/null
...
function createOrg2() {
  ...
  set -x
  fabric-ca-client enroll -u https://ADMIN-adminOrg2:adminpw@localhost:8054 --caname ca-org2 --tls.certfiles "${PWD}/organizations/fabric-ca/org2/ca-cert.pem"
  { set +x; } 2>/dev/null
