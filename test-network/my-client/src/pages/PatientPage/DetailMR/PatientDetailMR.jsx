...
import "../../DoctorPage/CreateMR/CreateMR.css";
...
import patientSlice, { patientSelector } from "../PatientSlice";
const PatientDetailMR = () => {
    ...
    const medicalRecord = patientSelect.medicalRecord;

    const doctor = patientSelect.detailDoctor;
    const treatments = patientSelect.treatments;
    const patient = user;
    console.log(doctor)
    ...
    useEffect(() => {
        ...
        return () => {
            dispatch(patientSlice.actions.setMedicalRecord(null));
            dispatch(patientSlice.actions.setTreatments([]));
        }
    }, [])
...
export default PatientDetailMR;
